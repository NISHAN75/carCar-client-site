...
const Features = () => {
  return (
    <div className="mt-20">
      ...
      >
        <SwiperSlide>
          <div className="grid grid-cols-3 my-8 mx-20 gap-5">
            <div class="card w-full bg-pirmary shadow-xl relative ">
              <figure>
                <img
              ...
              <div class="card-body">
                <h2 class="card-title font-bold text-pirmary">
                ...
                <div class="card-actions mt-8">
                  <button class="btn btn-primary absolute bottom-0 left-0 w-full hover:bg-white ">
                    Explore More
                  </button>
                </div>
              </div>
