...
const SubCard = () => {
  return (
    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 my-28 mx-10 gap-8 ">
      <div class="card p-5 w-full bg-primary shadow-xl animate__animated animate__backInLeft animate__delay-2s">
      ...
      <div class="card p-5 w-full bg-primary shadow-xl animate__animated animate__backInLeft animate__delay-2.5s">
      ...
      <div class="card p-5 w-full bg-primary shadow-xl animate__animated animate__backInRight animate__delay-2s">
      ...
      <div class="card w-full bg-primary shadow-xl animate__animated animate__backInRight animate__delay-2.5s">
